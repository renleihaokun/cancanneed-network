...
// .wrangler/tmp/bundle-0r6QEI/strip-cf-connecting-ip-header.js
...
${JSON.stringify(userInfo, null, 2)}`
    ...
    c.executionCtx.waitUntil(
      (async () => {
        ...
        try {
          ...
          console.error("[AI] Stream processing error:", error3);
    ...
    console.error(`[AI] Error: ${error3.message}`);
...
// .wrangler/tmp/bundle-0r6QEI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-0r6QEI/middleware-loader.entry.ts
