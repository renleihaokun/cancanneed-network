            ...
            <div class="info-box">
                ...
                <div class="chart-wrapper">
                    <div class="switch-container">
                        ...
                        <label for="s-opt-6" class="switch-option">Steam</label>
                        <input type="radio" id="s-opt-7" name="switch" class="switch-input" onchange="changePingTarget(7)">
                        <label for="s-opt-7" class="switch-option">Cloudflare</label>
...
// .wrangler/tmp/bundle-Q2WLFI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Q2WLFI/middleware-loader.entry.ts
