    ...
    async fetch(request, env) {
      ...
      if (action === 'analyze') {
        try {
          ...
          const apiKey = env.ZHIPU_API_KEY; // 请确保在 Cloudflare 后台配置此变量
  
          if (!apiKey) {
            return new Response("服务器未配置AI密钥", { status: 500 });
          }
          ...
          <style>
              * { margin: 0; padding: 0; box-sizing: border-box; }
              ...
              .info-box {
                  ...
                  border-radius: 12px; font-size: 0.95rem; color: #666;
              ...
              .value { font-family: monospace; color: #333; text-align: right; word-break: break-word; display: flex; align-items: center; justify-content: flex-end; }
              ...
              .ai-result {
                  ...
                  color: #333; border: 1px solid #a8e063; animation: fadeIn 0.5s ease-out;
              }
              ...
              .modal-header {
                  display: flex; justify-content: space-between; align-items: center;
                  margin-bottom: 15px; border-bottom: 1px solid #eee; padding-bottom: 10px; flex-shrink: 0;
              }
              .modal-title { font-size: 1.2rem; font-weight: bold; color: #333; }
              .modal-close {
                  cursor: pointer; font-size: 1.5rem; color: #999; line-height: 1;
              ...
              .modal-stats {
                  display: flex; gap: 20px; font-size: 0.9rem; color: #666; 
                  flex-shrink: 0; padding-top: 5px; border-top: 1px dashed #eee;
              }
              .stat-item b { font-family: monospace; color: #2b5876; }
              ...
              .switch-container {
                  ...
                  border: 1px solid rgba(255,255,255,0.3); height: 32px;
                  flex-shrink: 0;
              }
              .modal-content .switch-container {
                  background: #f0f2f5; border: 1px solid #e1e4e8; margin-bottom: 15px;
              }
              .switch-option {
                  flex: 1; text-align: center; z-index: 2; cursor: pointer;
                  font-size: 0.75rem; color: #666; font-weight: 600;
                  transition: color 0.3s, transform 0.1s ease; /* 添加 transform 过渡 */
              ...
              .switch-glider {
                  ...
                  width: calc((100% - 6px) / 5); background: #fff; border-radius: 16px;
              ...
              /* 颜色高亮 */
              input:checked + label { color: #2b5876; }
      ...
      <body>
          ...
          <script>
              ...
              async function fetchIpDetails() {
                  ...
                  const ipv4Promise = fetch('https://ipv4.icanhazip.com').then(res => res.text()).then(ipv4 => {
                  ...
                  ipv4Promise.then(ipv4 => {
                      ...
                      fetch(\`https://ipapi.co/\${ipv4}/json/\`)
                          ...
                          .catch(err => { 
                              document.getElementById('ext-loc').innerText = '查询超时'; 
                          })
                          .finally(() => {
                              startAiAnalysis();
                          });
              ...
              // 状态变量
              const historyLimit = 200; // 记录最近 200 次 (大图用)
              const smallViewLimit = 50; // 小图只显示最近 50 次
              ...
              // 调整画布大小 (修复版：使用 clientWidth 避免 transform 缩放导致的分辨率错误)
              function resizeCanvas(canvas, ctx) {
                  const dpr = window.devicePixelRatio || 1;
                  // 关键修改：使用 clientWidth/Height 获取布局尺寸，而非 getBoundingClientRect 的视觉尺寸
              ...
              window.openModal = function() {
                  ...
                  isModalOpen = true;
                  // 延迟一点点确保布局完成，虽然 clientWidth 比较稳，但加个保险
                  setTimeout(() => {
              ...
              function drawCharts() {
                  ...
                  if (isModalOpen) {
                      renderLineChart(largeCtx, largeCanvas, pingData, true);
                  }
              }
