/** Cloudflare speed.cloudflare.com /locations 中英对照（展示用） */

export const SPEED_REGION_ZH = {
  Africa: "非洲",
  "Asia Pacific": "亚洲",
  Europe: "欧洲",
  "Middle East": "中东",
...
export const SPEED_CITY_ZH = { ...SPEED_CITY_ZH_1, ...SPEED_CITY_ZH_2 };

export function localizeSpeedLocations(locations) {
