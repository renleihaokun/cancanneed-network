...
/** 区域中文化映射 */
export const SPEED_REGION_ZH: Record<string, string> = {
  Africa: '非洲',
  'Asia Pacific': '亚洲',
  Europe: '欧洲',
  'Middle East': '中东',
...
/** 城市中文化映射（第一部分） */
const SPEED_CITY_ZH_1: Record<string, string> = {
  Abidjan: '阿比让',
  Accra: '阿克拉',
  Adelaide: '阿德莱德',
  Ahmedabad: '艾哈迈达巴德',
...
/** 城市中文化映射（第二部分） */
const SPEED_CITY_ZH_2: Record<string, string> = {
...
/** 合并的城市中文化映射 */
export const SPEED_CITY_ZH: Record<string, string> = {
  ...SPEED_CITY_ZH_1,
  ...SPEED_CITY_ZH_2,
};
 ...
 * 本地化测速点列表
 * 将区域和城市名称翻译为中文
 * @param locations - 原始测速点列表
 * @returns 翻译后的测速点列表
 */
export function localizeSpeedLocations(
